...
DropdownChoose~V,D~ --> SelectModalContent~V,D~ : "构建弹窗内容"
SelectModalContent~V,D~ --> SelectModalContentList~V,D~ : "渲染列表"
DropdownChoose~V,D~ --> WrapperContainer~V,D~ : "表单包装"
WrapperContainer~V,D~ --> SuffixIconLabel : "动态后缀图标和清除功能"
SelectModalContentList~V,D~ --> SelectItem~V,D~ : "使用数据项"
