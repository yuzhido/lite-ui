...
## 更新摘要
**所做更改**
- 新增弹窗状态管理功能，支持动态后缀图标显示
- 增强 WrapperContainer 组件，支持根据选择状态和弹窗展开状态切换图标
- 优化远程数据缓存机制，提升性能表现
- 完善用户体验，提供更直观的交互反馈
...
**最新更新**：组件现已支持弹窗状态管理和动态后缀图标显示，能够根据用户交互状态智能切换右侧图标，提供更好的视觉反馈和用户体验。
...
**图表来源**
- [lib/src/dropdown_choose/dropdown_choose.dart:1-432](file://lib/src/dropdown_choose/dropdown_choose.dart#L1-L432)
...
- [lib/src/wrapper_container/index.dart:1-135](file://lib/src/wrapper_container/index.dart#L1-L135)
- [lib/src/widgets/suffix_icon_label.dart:1-30](file://lib/src/widgets/suffix_icon_label.dart#L1-L30)
...
**更新**：组件现在维护 `_isExpanded` 状态变量，在弹窗打开时设置为 true，关闭时重置为 false，用于驱动 WrapperContainer 中的动态后缀图标显示。
...
DC->>SM : showModalBottomSheet(传入 items/onRemoteSearch/multiple/selectedValues...)
...
SM-->>U : pop(value) 或关闭弹窗
DC->>W : setState(_isExpanded = false)
W->>I : 恢复默认图标状态
```

**图表来源**
- [lib/src/dropdown_choose/dropdown_choose.dart:382-424](file://lib/src/dropdown_choose/dropdown_choose.dart#L382-L424)
...
- [lib/src/widgets/suffix_icon_label.dart:17-26](file://lib/src/widgets/suffix_icon_label.dart#L17-L26)
...
**更新**：组件现在维护弹窗展开状态，并在 WrapperContainer 中传递相关参数以实现动态后缀图标显示。

**章节来源**
- [lib/src/dropdown_choose/dropdown_choose.dart:275-276](file://lib/src/dropdown_choose/dropdown_choose.dart#L275-L276)
- [lib/src/dropdown_choose/dropdown_choose.dart:379-381](file://lib/src/dropdown_choose/dropdown_choose.dart#L379-L381)
- [lib/src/dropdown_choose/dropdown_choose.dart:382-424](file://lib/src/dropdown_choose/dropdown_choose.dart#L382-L424)
...
**更新**：新增对弹窗展开状态和选择状态的监听，动态切换右侧图标样式。

**章节来源**
- [lib/src/wrapper_container/index.dart:52-59](file://lib/src/wrapper_container/index.dart#L52-L59)
- [lib/src/wrapper_container/index.dart:123-127](file://lib/src/wrapper_container/index.dart#L123-L127)

### SuffixIconLabel 动态后缀图标
- **智能图标切换**：根据选择状态和弹窗展开状态显示不同图标
- **状态判断逻辑**：
  - 有选中值：显示红色关闭图标 (Icons.close)
...
**更新**：现在还包括弹窗状态变化的隐式回调，通过 UI 图标的变化反映给用户。
...
**章节来源**
- [lib/src/models/callbacks.dart:1-13](file://lib/src/models/callbacks.dart#L1-L13)
- [lib/src/dropdown_choose/dropdown_choose.dart:399-414](file://lib/src/dropdown_choose/dropdown_choose.dart#L399-L414)
...
- 搜索交互依赖 InputSearch
- **WrapperContainer 依赖 SuffixIconLabel 实现动态图标**
- 数据模型与回调类型集中定义于 models 目录

**更新**：新增了 WrapperContainer 与 SuffixIconLabel 的依赖关系，形成完整的动态图标显示链路。
...
WrapperContainer --> SuffixIconLabel : "动态后缀图标"
SelectModalContentList --> SelectItem : "使用数据项"
```

**图表来源**
- [lib/src/dropdown_choose/dropdown_choose.dart:11-258](file://lib/src/dropdown_choose/dropdown_choose.dart#L11-L258)
- [lib/src/dropdown_choose/ui/select_modal_content.dart:22-134](file://lib/src/dropdown_choose/ui/select_modal_content.dart#L22-L134)
- [lib/src/wrapper_container/index.dart:13-78](file://lib/src/wrapper_container/index.dart#L13-L78)
- [lib/src/widgets/suffix_icon_label.dart:3-7](file://lib/src/widgets/suffix_icon_label.dart#L3-L7)
...
- **状态管理优化**：_isExpanded 状态变更仅影响 WrapperContainer 的重建，影响范围最小化

**更新**：新增了对状态管理优化的建议，确保弹窗状态变更的性能影响最小化。
...
**更新**：新增了对动态图标和弹窗状态相关的故障排查指导。

**章节来源**
- [lib/src/dropdown_choose/dropdown_choose.dart:247-254](file://lib/src/dropdown_choose/dropdown_choose.dart#L247-L254)
...
## 结论
DropdownChoose 提供了完善的下拉选择能力，覆盖表单集成、本地/远程搜索、多选限制、值显示定制、禁用项与占位提示、新增与查看已选等功能。**最新版本增强了弹窗状态管理和动态后缀图标显示**，通过智能的图标切换逻辑为用户提供更直观的交互反馈。通过合理的缓存与搜索策略，可在大列表与远程数据场景下获得良好性能与用户体验。

**更新总结**：新增的弹窗状态管理和动态图标功能显著提升了用户体验，使组件更加直观和易用。
...
**更新**：组件内部现在维护 `_isExpanded` 状态变量，用于控制弹窗展开状态和动态图标显示。

**章节来源**
- [lib/src/dropdown_choose/dropdown_choose.dart:11-116](file://lib/src/dropdown_choose/dropdown_choose.dart#L11-L116)
- [lib/src/dropdown_choose/dropdown_choose.dart:219-258](file://lib/src/dropdown_choose/dropdown_choose.dart#L219-L258)
- [lib/src/dropdown_choose/dropdown_choose.dart:275-276](file://lib/src/dropdown_choose/dropdown_choose.dart#L275-L276)
...
**新增功能**：这些参数用于实现动态后缀图标显示，根据用户交互状态智能切换图标。
...
**更新说明**：所有现有示例都自动支持新的动态图标功能，无需修改代码即可体验增强的用户体验。