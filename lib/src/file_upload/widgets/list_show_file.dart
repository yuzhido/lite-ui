...
class ListShowFile extends StatelessWidget {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          // 内容层（保持原有 padding）
          Padding(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10), child: _buildContent(context, theme, statusColor)),
        ],
      ),
    );
  }
  ...
  /// 构建内容行
  Widget _buildContent(BuildContext context, ThemeData theme, Color statusColor) {
    return Row(
      children: [
        // 文件类型图标
